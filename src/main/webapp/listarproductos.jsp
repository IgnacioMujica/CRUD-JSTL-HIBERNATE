...
<!--  LOGO  -->
	...
	<div>
      <img class=icon src="images/listar_bd.png" alt="icono listar">
   </div>
<!--  /LOGO  -->
		<span class="navbar-brand">LISTAR</span>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active">
					<a class="nav-link" href="#">Listar Productos<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="PreIngresarServlet">Agregar Producto<span class="sr-only"></span></a>
				</li>
				<li class="nav-item">
...
<table class="table table-striped">
	...
	<c:forEach var="productos" items="${requestScope.productos}">
		<tr>
			<td style="text-align:center;"><c:out value="${productos.getIdProducto()}"/></td>
			<td><c:out value="${productos.getNombreProducto()}"/></td>
			<td style="text-align:center;"><c:out value="${productos.getPrecioProducto()}"/></td>
